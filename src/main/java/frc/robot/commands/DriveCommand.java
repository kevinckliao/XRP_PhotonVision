...
public class DriveCommand extends Command {
   ...
   */
  public DriveCommand(XRPDrivetrain subsystem, DoubleSupplier RightX, DoubleSupplier LeftY) {
  ...
  @Override
  public void execute() {
    m_subsystem.arcadeDrive(forward.getAsDouble(), rotation.getAsDouble());
